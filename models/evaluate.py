...
def evaluateModel(model, XTest, yTest):
    ...
    # Calibration lines (FIXME: Uncomment currently but in future look into moving / editing this all into a seperate location)
...
# Calibration check and fit functions (For betting)
